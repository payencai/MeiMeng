package com.example.meimeng.common.rv.absRv;
...
public abstract class AbsBaseActivity<T> extends BaseActivity implements View.OnClickListener {
...
//        setContentView(R.layout.activity_abs_base);
//    }
