...
import com.example.meimeng.test.ForegroundActivity;
import com.example.meimeng.test.TestLocationActivity;
    ...
    protected void onStart() {
        ...
        FunctionList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                switch (arg2) {
                    case 0:
                        TargetClass = TestLocationActivity.class;
                        break;
                    case 1:
...
//                        TargetClass = QuestActivity.class;
                ...
                if (TargetClass != null) {
                    Intent intent = new Intent(TestActivity.this, TargetClass);
