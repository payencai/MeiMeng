...
import com.example.meimeng.common.rv.cell.EmptyCell;
import com.example.meimeng.common.rv.cell.ErrorCell;
import com.example.meimeng.common.rv.cell.LoadMoreCell;
import com.example.meimeng.common.rv.cell.LoadingCell;
...
public class RVSimpleAdapter extends RVBaseAdapter {
    ...
    protected void onViewHolderBound(RVBaseViewHolder holder, int position) {
        ...
        Log.d("lingtao", "onViewHolderBound: 绑定数据之前的操作onViewHolderBound");
    }
    ...
    public void showLoadMore(View loadMoreView, int height) {
        ...
        //设置默认高度
        if (height == 0) {
            int defaultHeight = DisplayUtils.dpToPx(loadMoreView.getContext(), LoadMoreCell.mDefaultHeight);
