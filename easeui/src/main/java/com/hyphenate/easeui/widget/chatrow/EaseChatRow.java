    ...
    private void setUpBaseView() {
        ...
        if (userAvatarView != null) {
            ...
            if (message.direct() == Direct.SEND) {
                Log.e("send", message.getUserName() + "");
                try {
                    EaseUserUtils.setUserAvatar2(context, message.getStringAttribute("headimg"), userAvatarView);
                ...
                try {
                    EaseUserUtils.setUserAvatar2(context, message.getStringAttribute("headimg"), userAvatarView);
                    EaseUserUtils.setNickName(message.getStringAttribute("nikename"), usernickView);
                } catch (HyphenateException e) {
                    e.printStackTrace();
                }
