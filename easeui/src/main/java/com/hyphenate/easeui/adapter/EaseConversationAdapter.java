...
//            }
//            Glide.with(getContext()).load(conversation.getLastMessage().getStringAttribute("headimg", ""))
//                    .placeholder(R.drawable.ease_default_avatar)
//                    .into(holder.avatar);
//            holder.name.setText(conversation.getLastMessage().getStringAttribute("nikename", ""));
            holder.motioned.setVisibility(View.GONE);
        }
